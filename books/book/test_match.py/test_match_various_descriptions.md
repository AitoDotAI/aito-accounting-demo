# _match: vendor resolution from bank descriptions
...
_match traverses schema links and finds associated records.
Some vendors may not match due to sparse training data.
